...
namespace TimerTest
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void ShouldDisplay66SecondsToStringAsNewTest()
        {
            timer.Seconds = 2341;
            Assert.AreEqual("00:39:01", timer.ToString());
        }
        [TestMethod]
        public void ShouldDisplay66SecondsToStringAsNewTestPart2()
        {
            timer.Seconds = 2351;
            Assert.AreEqual("00:39:11", timer.ToString());
        }
        [TestMethod]
        public void ShouldDisplay66SecondsToStringAsNewTestPart3()
        {
            timer.Seconds = 117;
            Assert.AreEqual("00:01:57", timer.ToString());
        }
        [TestMethod]
